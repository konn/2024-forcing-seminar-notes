...
RUN opam install satysfi-azmath satysfi-figbox satysfi-class-slydifi satysfi-bibyfi satysfi-fss satysfi-ruby satysfi-class-jlreq satysfi-latexcmds satysfi-matrix satysfi-arrows satysfi-easytable satysfi-colorbox satysfi-fonts-noto-serif-cjk-jp satysfi-fonts-noto-sans-cjk-jp satysfi-derive satysfi-uline satysfi-ncsq
